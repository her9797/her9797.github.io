                ...
                {page === 2 && (
                    <div className="about" style={{ height: '600px', overflowY: 'auto' }}>
                        ...
                        <div className="about-caption">
                            ...
                            <p className='korean-text'>
                                프로젝트를 진행하던 초기에는 기본적인 CRUD의 기능들을 구현하였으나, 후에 사용자 간 실시간 채팅을 위해 웹소켓을 도입하고 싶었습니다. 이는 단순히 기능 추가 이상의 의미를 가지고 있었습니다. 처음에는 "있으면 좋겠다"는 작은 생각에서 출발했지만, 제 자신의 능력을 믿고 도전하며 "할 수 있다"는 확신을 갖게 되었습니다. 클라이언트와 서버 간의 실시간 데이터 흐름을 관리하고 보안 문제를 해결하는 과정에서의 어려움도 있었지만, 지속적인 학습과 실험을 통해 이를 극복했습니다.
                            </p>
                        </div>
                    </div>
                )}
